...
export default function SaveFeedback({ message, position = 'inline' }: SaveFeedbackProps) {
  ...
  return (
    <div className="save-feedback-wrapper" style={position === 'top' ? { position: 'fixed', ...positionStyle, zIndex: 10000 } : {}}>
